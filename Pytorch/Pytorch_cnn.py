...
class SimpleConvNet(nn.Module):
    ...
    def __init__(self, input_shape=(32, 32), num_classes=100):
        ...
        # 2 convolutions
        layers.append(nn.Conv2d(3, 104, kernel_size=5, stride=2, padding=2,bias=False))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.MaxPool2d(kernel_size=3, stride=2))
        layers.append(nn.Conv2d(104, 208, kernel_size=3, stride=1, padding=2,bias=False))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.MaxPool2d(kernel_size=2, stride=2))
        layers.append(nn.Conv2d(208, 416, kernel_size=3, stride=1, padding=1,bias=False))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.Conv2d(416, 256, kernel_size=3, stride=1, padding=1,bias=False))
        layers.append(nn.ReLU(inplace=True))
        ...
        layers.append(nn.Linear(256, 2048))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.Dropout(p=0.5))
